package com.state.psa.character.config;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.state.psa.character..*(..)))")
    ...
    @Before("execution(* com.state.psa.character..*(..)))")
    ...
    @After("execution(* com.state.psa.character..*(..)))")
